namespace NAudio.Flac
{
	...
	{
		public static readonly int[] SampleRateTable = new int[16]
		{
			-1,
			88200,
			176400,
		...
		public static readonly int[] BitPerSampleTable = new int[8]
		{
			-1,
			8,
			12,
		...
		public static readonly int[] FlacBlockSizes = new int[15]
		{
			0,
			192,
			576,
